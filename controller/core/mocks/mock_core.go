...
// Source: opensearch-cli/controller/core (interfaces: Controller)
...
import (
	context "context"
	core "opensearch-cli/entity/core"
	reflect "reflect"
...
func (m *MockController) Curl(arg0 context.Context, arg1 core.CurlCommandRequest) ([]byte, error) {
	m.ctrl.T.Helper()
